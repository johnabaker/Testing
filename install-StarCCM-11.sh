...
wget -q http://azbenchmarkstorage.blob.core.windows.net/cdadapcobenchmarkstorage/STAR-CCM+11.06.011_01_linux-x86_64.tar.gz -O /mnt/resource/scratch/STAR-CCM+11.06.011_01_linux-x86_64.tar.gz
...
tar -xzf /mnt/resource/scratch/STAR-CCM+11.06.011_01_linux-x86_64-r8.tar.gz -C /mnt/resource/scratch/INSTALLERS/
