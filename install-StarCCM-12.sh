...
wget -q http://azbenchmarkstorage.blob.core.windows.net/cdadapcobenchmarkstorage/STAR-CCM+12.02.010_01_linux-x86_64.tar.gz -O /mnt/resource/scratch/INSTALLERS/STAR-CCM+12.02.010_01_linux-x86_64.tar.gz
...
tar -xzf /mnt/resource/scratch/INSTALLERS/STAR-CCM+12.02.010_01_linux-x86_64.tar.gz -C /mnt/resource/scratch/INSTALLERS/
...
rm -rf /mnt/resource/scratch/INSTALLERS/STAR-CCM+12.02.010_01_linux-x86_64.tar.gz
