...
wget -q http://azbenchmarkstorage.blob.core.windows.net/cdadapcobenchmarkstorage/STAR-CCM+12.02.011_01_linux-x86_64.tar.gz -O /mnt/resource/scratch/STAR-CCM+12.02.011_01_linux-x86_64.tar.gz
...
tar -xzf /mnt/resource/scratch/STAR-CCM+12.02.011_01_linux-x86_64.tar.gz -C /mnt/resource/scratch/INSTALLERS/

cd /mnt/resource/scratch/INSTALLERS/starccm+_12.02.011/
